...
printf("GHWPARAMS0: %08X\n", *((uint32_t *)(mmio + GHWPARAMS0)));
printf("GHWPARAMS1: %08X\n", *((uint32_t *)(mmio + GHWPARAMS1)));
printf("GHWPARAMS2: %08X\n", *((uint32_t *)(mmio + GHWPARAMS2)));
printf("GHWPARAMS3: %08X\n", *((uint32_t *)(mmio + GHWPARAMS3)));
printf("GHWPARAMS4: %08X\n", *((uint32_t *)(mmio + GHWPARAMS4)));
printf("GHWPARAMS5: %08X\n", *((uint32_t *)(mmio + GHWPARAMS5)));
printf("GHWPARAMS6: %08X\n", *((uint32_t *)(mmio + GHWPARAMS6)));
printf("GHWPARAMS7: %08X\n", *((uint32_t *)(mmio + GHWPARAMS7)));
printf("GHWPARAMS8: %08X\n", *((uint32_t *)(mmio + GHWPARAMS8)));
